 ...
 <div  class="container-fluid mt-4"> 
      <!-- Breadrumb -->
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo base_url() ?>/Developer/Dashboard">Dashboard</a></li>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card bg-warning text-white h-100">
            <div class="card-body">
              ...
              <div class="mr-5">11 finished tasks</div>
            </div>
            <a href="#" class="card-footer clearfix small text-white"><span class="float-left">View Details</span><span class="float-right"><i class="fa fa-angle-right"></i></span></a> </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card bg-success text-white h-100">
            <div class="card-body">
              ...
              <div class="mr-5">123 unfinished tasks</div>
            </div>
            <a href="#" class="card-footer clearfix small text-white"><span class="float-left">View Details</span><span class="float-right"><i class="fa fa-angle-right"></i></span></a> </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card bg-danger text-white h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Marked Complete by the manager</div>
            </div>
            <a href="#" class="card-footer clearfix small text-white"><span class="float-left">View Details</span><span class="float-right"><i class="fa fa-angle-right"></i></span></a> </div>
        </div>
      </div>