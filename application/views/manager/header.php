...
<body id="pageTop">
<!-- Top Navbar -->
<nav class="navbar navbar-expand navbar-dark bg-dark fixed-top" id="topNav"> <a href="index.html" class="navbar-brand">Project Manager</a>
...
<div class="wrapper mt-5">
  ...
  <nav id="sidebar">
    <ul class="navbar-nav">
      <li class="nav-item active pt-3"><a href="<?=base_url().'manager/Dashboard';?>" class="nav-link text-white"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a> </li>
      <li class="nav-item pt-3" id="pageItem"><a href="#pageSubMenu" class="nav-link dropdown-toggle text-white" data-toggle="collapse" aria-expanded="false" role="button"><i class="fa fa-folder"></i> <span>Manage</span></a>
        <div class="dropdown-menu mr-4" id="pageSubMenu">
          ...
          <a href="<?=base_url().'manager/developer/all_developers';?>" class="dropdown-item">Developers</a>
          <a href="<?=base_url().'manager/developer/add_developer';?>" class="dropdown-item">Add Developer</a>
          <div class="dropdown-divider"></div>
          <h6 class="dropdown-header">Projects</h6>
          <a href="<?=base_url().'manager/project/all_projects';?>" class="dropdown-item">All projects</a>
          <a href="<?=base_url().'manager/project/add_project';?>" class="dropdown-item">Add New project</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
